...
function generateReadmeFromSelection(
  ...
  lines.push("");
  lines.push("This is an [Agent Company](https://paperclip.ing) package, powered by [Artu Teams](https://paperclip.ing).");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Artu Teams](https://paperclip.ing) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [Artu Teams](https://paperclip.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
